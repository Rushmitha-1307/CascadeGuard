# %% [markdown]
# # TRUSTGUARD — Dual-Model Sycophancy-Induced Hallucination
# ## Kaggle T4 Only | LLaMA-2-7b-chat + Mistral-7B-Instruct-v0.2 | MedMCQA
# Run cells in order. Every cell is independent — no hidden state dependencies.
...
try:
    ...
    HF_TOKEN = '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'   # <-- replace if Secrets not set up
...
# ---
# ## MITIGATION PHASE
# Run after Cell 13. Uses whichever model showed positive delta.
...
try:
    ...
    HF_TOKEN = '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'   # fallback
login(token=HF_TOKEN, add_to_git_credential=False)
